...
export const CardSubtitle = ({ className, ...props }: CardSubtitleProps) => {
  return (
    <h4
      className={cn(
        "-mt-6 mb-2 text-base font-normal leading-6 text-gray-500",
        className,
      )}
      {...props}
    />
...
export const CardTools = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col flex-wrap items-stretch gap-2 sm:flex-row sm:items-start",
        className,
      )}
      {...props}
    />
...
export const CardTitleActions = ({
  className,
  ...props
}: CardTitleActionsProps) => {
  return (
    <div
      className={cn(
        "flex flex-col flex-wrap items-stretch gap-2 text-base font-normal sm:flex-row sm:items-center",
