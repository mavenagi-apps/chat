    ...
    >
      ...
      <HeadlessInput
        className={cn([
          ...
          props.type === "color" &&
            "h-full px-[calc(theme(spacing[1])-2px)] py-0",
          ...
          Icon &&
            "pl-[calc(theme(spacing[10])-1px)] sm:pl-[calc(theme(spacing[10])-1px)]",

          RightIcon &&
            "pr-[calc(theme(spacing[10])-1px)] sm:pr-[calc(theme(spacing[10])-1px)]",
        ])}
        {...props}
      />
    </span>
