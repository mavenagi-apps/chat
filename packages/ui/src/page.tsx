...
export const PageContainer = ({
  ...
  <div
    className={cn(
      "flex flex-1 flex-col gap-6 overflow-auto bg-gray-50 p-6 pb-20",
      className,
    )}
    {...props}
  />
...
export const PageSubtitle = ({ className, ...props }: PageSubtitleProps) => (
  <div
    className={cn(
      "flex flex-wrap gap-4 text-sm font-normal leading-5 text-gray-500",
      className,
    )}
    {...props}
  />
