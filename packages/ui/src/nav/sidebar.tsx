...
export type SidebarItemGroupProps = React.PropsWithChildren<{
  className?: string;
}>;
...
export type SidebarSubItemProps = React.PropsWithChildren<{
  href?: string;
  active?: boolean;
  className?: string;
}>;
...
export type SidebarBackButtonProps = React.PropsWithChildren<{
  className?: string;
  href: string;
}>;
...
export type SidebarMenuItemsProps = React.PropsWithChildren<{
  className?: string;
}>;
export const SidebarMenuItems = ({
  ...
  return (
    <DropdownMenu
      anchor="top"
      className={cn("z-[999] min-w-[14rem]", className)}
    >
      {children}
    </DropdownMenu>
  );
